...
class Test_BaseModel(unittest.TestCase):
    ...
    def test_text(self):
        """this tests methods"""
        self.text = "b6a6e15c-c67d-4312-9a75-9d084935e579"
        self.assertEqual("b6a6e15c-c67d-4312-9a75-9d084935e579", self.text)
    ...
    def test_place_id(self):
        """this tests methods"""
        self.place_id = "mi casa"
        self.assertEqual("mi casa", self.place_id)
